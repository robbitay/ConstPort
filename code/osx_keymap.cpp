...
Date:   10\07\2017
Description: 
	** Handles mapping GLFW input to application input buttons
*/
	...
	if (buttonState->isDown != pressed)
	{
		...
		else
		{
			...
			for (u8 keyIndex = 0; keyIndex < numKeys; keyIndex++)
			{
				...
				{
					OSX_WriteLine("Other mouse button held, ignoring button release");
			...
			if (!foundPressedKey)
			{
				...
				for (u8 keyIndex = 0; keyIndex < numKeys; keyIndex++)
				{
					...
					{
						OSX_WriteLine("Other key held, ignoring button release");
	...
	if (buttonState->isDown != pressed)
	{
		...
		else
		{
			...
			for (u8 keyIndex = 0; keyIndex < numKeys; keyIndex++)
			{
				...
				{
					OSX_WriteLine("Other mouse button held, ignoring key release");
			...
			if (!foundPressedKey)
			{
				...
				for (u8 keyIndex = 0; keyIndex < numKeys; keyIndex++)
				{
					...
					{
						OSX_WriteLine("Other key held, ignoring key release");

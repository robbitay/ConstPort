...
if "%DebugBuild%"=="1" (
	...
	set DebugDependantLibraries=glew32d.lib libboost_regex-vc140-mt-sgd-1_65_1.lib
) else (
	...
	set DebugDependantLibraries=glew32.lib libboost_regex-vc140-mt-s-1_65_1.lib
)
...
set IncludeDirectories=/I"W:\lib\mylib" /I"W:\lib\glew-2.0.0\include" /I"W:\lib\glfw-3.2.1\include" /I"W:\lib\stb" /I"W:\lib\jsmn" /I"W:\lib\boost_1_65_1"
set LibraryDirectories=%DebugDependantPaths% /LIBPATH:"W:\lib\boost_1_65_1\stage\lib"
